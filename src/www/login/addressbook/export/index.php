...
if( $mail->MailPostIs('export') ) {

	$mail->MailBookExport($_POST['export']);
}
		...
		<table width="800" border="0" cellspacing="0" cellpadding="0" height="28">
		  <tr align="left" valign="bottom"> 
			...
			<td height="47" width="194" valign="top" align="left"> <form action="" method="post" name="email" id="email">
				...
				<? print($mail->mail_folder_view_top); ?> </form></td>
		  </tr>
		</table>
		  ...
		  <tr> 
			...
			<td width="761" align="left" valign="top"> <table width="771" border="0" cellpadding="0" cellspacing="0" class="akalink">
				...
				<tr align="left" valign="middle"> 
				  <td height="38" colspan="2">This feature allows you to export 
					your AKAMail address book to other popular e-mail programs. 
					To begin exporting your address book contacts simply choose 
					the program you want to export your address book to. </td>
				</tr>
			  </table>
			  <table cellpadding=4 cellspacing=0 border=0 class=barlink width="100%">
				<tr class=frmb> 
				  <td width="529" align="left" valign="top"><form action="" method="post" name="export" id="export">
					  <table width="85%" border="0">
						...
						<tr> 
						  <td width="42%"><span class="akalink"><strong><font color="#000000"> 
							Microsoft Outlook Express</font> </strong></span> 
						  </td>
						  <td width="58%"><span class="akalink"><strong><font color="#000000">Eudora 
							Lite &amp; Professional</font></strong></span></td>
						</tr>
						<tr> 
						  <td height="30"><input name="export[outlook]" type="image" id="export_outlook" src="/img/btn_exportnow.gif" width="117" height="28" border="0"></td>
						  <td><input name="export[eudora]" type="image" id="export_eudora" src="/img/btn_exportnow.gif" width="117" height="28" border="0"></td>
						</tr>
					  </table>
					  <table width="85%" border="0">
						<tr> 
						  <td width="42%" height="22" valign="bottom"><span class="akalink"><strong><font color="#000000"> 
							Netscape Address Book </font> </strong></span> </td>
						  <td width="58%" valign="bottom"><span class="akalink"><strong><font color="#000000">Text 
							Delimited Format </font></strong></span></td>
						</tr>
						<tr> 
						  <td><input name="export[netscape]" type="image" id="exportnow_netscape" src="/img/btn_exportnow.gif" width="117" height="28" border="0"></td>
						  <td><input name="export[text]" type="image" id="exportnow_text" src="/img/btn_exportnow.gif" width="117" height="28" border="0"></td>
						</tr>
					  </table>
					</form></td>
				  <td width=226 valign=top> <table class=alerttable cellpadding=3 cellspacing=1 border=0>
					  <tr valign=top class="akalink"> 
						<td colspan=2 nowrap><font color="#000000"><strong>How 
						  Do I Export My Contacts?</strong></font></td>
					  </tr>
					  <tr class="akalink"> 
