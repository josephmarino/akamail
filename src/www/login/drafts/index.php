    ...
    <tr align=left valign="top"> 
      <td style="BORDER-RIGHT: #A3A3A3 1px solid; BORDER-TOP: #A3A3A3 1px solid; BORDER-LEFT: #A3A3A3 1px solid; BORDER-BOTTOM: #A3A3A3 1px solid"> 
        ...
        <table width="800" border="0" cellspacing="0" cellpadding="0">
            <tr> 
              <td width="369"><img src="/img/3_dv.gif" width="369" height="31"></td>
              <td width="80"><a href="http://<? print($mail->server['main']); ?>/login/inbox/" onMouseOver="window.status='View your inbox for new e-mail'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/3_in.gif" width="80" height="31" border="0"></a></td>
              <td width="66"><a href="http://<? print($mail->server['main']); ?>/login/sent/" onMouseOver="window.status='View your sent e-mail folder'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/3_sent.gif" width="66" height="31" border="0"></a></td>
              <td width="119"><a href="http://<? print($mail->server['main']); ?>/login/deleted/" onMouseOver="window.status='View all deleted e-mail'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/3_del.gif" width="119" height="31" border="0"></a></td>
              <td width="22"><a href="http://<? print($mail->server['main']); ?>/login/options/" onMouseOver="window.status='Edit your account settings'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/3_opt.gif" width="89" height="31" border="0"></a></td>
              <td width="144"><a href="http://<? print($mail->server['main']); ?>/login/drafts/" onMouseOver="window.status='View your e-mail drafts folder'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/3_draft.gif" width="77" height="31" border="0"></a></td>
            </tr>
          </table>
          ...
          <tr> 
            <td width="29">&nbsp;</td>
              <td width="761" align="left" valign="top"> <table width="770" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    <td width="509" class="akalink"><font color="#000000">Drafted 
                      Items: <strong><? print($mail->mail_status['msg_cnt']); ?> </strong><strong> 
                      </strong></font></td>
                ...
                <table width="100%" border="0">
                  <tr> 
                    <td width="98%" align="left" valign="top"><table cellspacing=0 cellpadding=0 width="100%" border=0>
                        <tbody>
                          <tr> 
                            <td bgcolor=#dcdcdc> <table width="100%" cellpadding="2" cellspacing="1">
                                ...
                                <? } else { ?>
                                 ...
                                 <? } ?>
                                  ...
                                  <td width="226" bgcolor="#FFFFFF"><b><b><font color="#000000">To</font></b><font color="#000000"> 
                                    </font> 
                              ...
                              <? } ?>
                                  ...
                                  <td width="263"><b><font color="#000000">Subject 
                                    </font> 
                    ...
                    <table width="769" border="0" cellspacing="0" cellpadding="0" height="45">
                      <tr valign="middle" class="akalink"> 
                        ...
                        <td width="94" height="51" align="left" valign="bottom"> 
                          <input name="changestatus" type="image" id="changestatus3" src="/img/btn_markas.gif" width="94" height="35" border="0"> 
                        </td>
