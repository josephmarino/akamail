...
function addressbook() {
	h3ll0=window.open('/login/addressbook/index.aka','elite','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=492,height=350');
}
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="20" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../../img/compose_eml_d.jpg','../../img/address_book_d.jpg','../../img/collect_email_d.jpg','/img/compose_eml_d.jpg','/img/address_book_d.jpg','/img/collect_email_d.jpg','/img/espm_filt_d.jpg','/img/inter_help_d.jpg','btn_logout_d.jpg','/img/btn_logout_d.jpg')" link="#0000cc" vlink="#0000cc" alink="#0000cc">
      ...
      <td style="BORDER-RIGHT: #A3A3A3 1px solid; BORDER-TOP: #A3A3A3 1px solid; BORDER-LEFT: #A3A3A3 1px solid; BORDER-BOTTOM: #A3A3A3 1px solid"> 
        <table width="800" border="0" cellspacing="0" cellpadding="0" height="28">
          <tr align="left" valign="bottom"> 
            ...
            <td height="47" width="558" valign="middle"> <a href="http://<? print($mail->server['main']); ?>"><img src="/img/top_logo_left.gif" width="388" height="48" border="0"></a></td>
              <td height="47" width="231" valign="top" align="left"><? print($mail->mail_folder_view_top); ?></td>
          </tr>
        </table>
            ...
            <tr> 
              <td height="2"><table width="800" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    ...
                    <td width="80"><a href="http://<? print($mail->server['main']); ?>/login/inbox/" onMouseOver="window.status='View your inbox for new e-mail'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/1_in.gif" width="80" height="31" border="0"></a></td>
                    <td width="76"><a href="http://<? print($mail->server['main']); ?>/login/sent/" onMouseOver="window.status='View your sent e-mail folder'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/1_sent.gif" width="76" height="31" border="0"></a></td>
                    ...
                    <td width="99"><a href="http://<? print($mail->server['main']); ?>/login/drafts/" onMouseOver="window.status='View your drafted e-mail folder'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/1_drafts.gif" width="68" height="31" border="0"></a></td>
                  </tr>
                </table>
                <? include($mail->tpl['html'] . '/toolbar.html'); ?></td>
            </tr>
          </table>
          ...
          <tr> 
            ...
            <td width="761" align="left" valign="top"> 
              <table width="770" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    <td width="509" class="akalink"><font color="#000000">Inbox 
                      (<? print($mail->mail_status['msg_cnt']); ?> messages , <b><? print($mail->mail_status['msg_unread']); ?>
                      unread</b> and <? print($mail->mail_status['msg_spam']); ?> Spam messages) </font></td>
                          ...
                          <tr> 
                            <td align="left" valign="top" bgcolor=#dcdcdc> <table width="100%" cellpadding="2" cellspacing="1">
                                <tr bgcolor="#FFFFFF" class="akalink"> 
                                  ...
                                  <td width="18"><div align="center"><b>
			 ...
			 <? if( $mail->mail_list_sort == 'mread ASC' ) { ?>
                        ...
                        <td width="18" bgcolor="#FFFFFF"><div align="center"><b>
			 ...
			 <? if( $mail->mail_list_sort == 'mpriority ASC' ) { ?>
                        ...
                        <td width="226" bgcolor="#FFFFFF"><b><font color="#000000">From</font> 
			...
			<font color="#000000"> </font></b></td>
                      ...
                      <table width="769" border="0" cellspacing="0" cellpadding="0" height="48">
                        <tr valign="middle" class="akalink"> 
                          <td width="431" height="51" valign="bottom"> <input type="image" border="0" name="delete" src="/img/btn_del.gif" width="100" height="35" onMouseOver="window.status='Delete selected e-mail'; return true;" onMouseOut="window.status=''; return true;">
                            <input name="empty" type="image" id="empty" src="/img/btn_empty_foldr.gif" width="120" height="35" border="0" onClick="return confirm('Are you sure you want to delete all <? print($mail->mail_status['msg_cnt']); ?>  e-mail messages ?');" onMouseOver="window.status='Delete all e-mail messages in this folder'; return true;" onMouseOut="window.status=''; return true;"> 
                            <input name="spamblock" type="image" id="spamblock" onMouseOver="window.status='Block selected sender from sending you e-mails'; return true;" onMouseOut="window.status=''; return true;" src="/img/btn_this_is_spam.gif" width="112" height="35" border="0"> 
                          ...
                          <td width="94" height="51" align="left" valign="bottom"> 
                            <input name="changestatus" type="image" id="changestatus" src="/img/btn_markas.gif" width="94" height="35" border="0"> 
                          </td>
                          <td width="126" height="51" valign="bottom"> <table width="104" border="0">
                              <tr valign="top"> 
                                <td width="98" height="36"> <select name="status" class="dropdowns">
...
<? if( $mail->mail_account_refresh_cnt > 0 ) print($mail->mail_account_reload_snd); ?>
</body>
</html>
