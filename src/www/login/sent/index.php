...
if( $mail->mail_option_list['sendsave'] == 0 ) {

	include($mail->tpl['php'] . '/folder_sent_nosave_toggle.tpl');
	$mail->folder_sent_nosave_toggle = $template;
}
?>
      ...
      <tr align=left valign="top"> 
        <td style="BORDER-RIGHT: #A3A3A3 1px solid; BORDER-TOP: #A3A3A3 1px solid; BORDER-LEFT: #A3A3A3 1px solid; BORDER-BOTTOM: #A3A3A3 1px solid"> 
          ...
          <table width="800" border="0" cellspacing="0" cellpadding="0">
            <tr> 
              <td width="364"><img src="/img/5_dv.gif" width="364" height="31"></td>
              <td width="79"><a href="http://<? print($mail->server['main']); ?>/login/inbox/" onMouseOver="window.status='View your inbox for new e-mail'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/5_in.gif" width="79" height="31" border="0"></a></td>
              <td width="76"><a href="http://<? print($mail->server['main']); ?>/login/sent/" onMouseOver="window.status='View your sent e-mail folder'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/5_sent.gif" width="76" height="31" border="0"></a></td>
              <td width="119"><a href="http://<? print($mail->server['main']); ?>/login/deleted/" onMouseOver="window.status='View all deleted e-mail'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/5_del.gif" width="119" height="31" border="0"></a></td>
              <td width="85"><a href="http://<? print($mail->server['main']); ?>/login/options/" onMouseOver="window.status='Edit your account settings'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/5_opt.gif" width="90" height="31" border="0"></a></td>
              <td width="77"><a href="http://<? print($mail->server['main']); ?>/login/drafts/" onMouseOver="window.status='View your e-mail drafts folder'; return true;" onMouseOut="window.status=''; return true;"><img src="/img/5_draft.gif" width="72" height="31" border="0"></a></td>
            </tr>
          </table>
              ...
              <td width="761" align="left" valign="top"> <table width="770" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    ...
                    <td height="24" valign="bottom" class="akalink"><font color="#000000">You 
                      are using <strong><? print($mail->mail_status['ind_size']); ?> 
                      MB </strong> of your <strong><? print($mail->mail_status['ind_maxsize']); ?> 
                      MB</strong> limit. </font></td>
                  </tr>
                  <tr> 
                    <td width="509" class="akalink"><font color="#000000">Sent 
                ...
                <? if( $mail->mail_option_list['sendsave'] == 1 ) { ?>
                ...
                <? if( $mail->mail_option_list['sendsave'] == 0 ) { ?>
                	...
                	<? print($mail->folder_sent_nosave_toggle); ?>
                <? } ?> 
                    ...
                    <td width="98%" align="left" valign="top"><table cellspacing=0 cellpadding=0 width="100%" border=0>
                        <tbody>
                          <tr> 
                            <td align="left" valign="top" bgcolor=#dcdcdc> <table width="100%" cellpadding="2" cellspacing="1">
                                <tr bgcolor="#FFFFFF" class="akalink"> 
                                  ...
                                  <td width="16"><div align="center"><b> 
                          ...
                          <?	} ?>
                                ...
                                <td width="16" bgcolor="#FFFFFF"><div align="center"><b> 
                          ...
                          <?	if( $mail->mail_list_sort == 'mpriority ASC' ) { ?>
                          	...
                          	<? } ?>
                                  ...
                                  <td width="223" bgcolor="#FFFFFF"><b><b><font color="#000000">Sent 
                                  To</font></b><font color="#000000"> </font> 
                        ...
                        <? } ?>
                                  ...
                                  <td width="237"><b><font color="#000000">Subject</font> 
                        ...
                        <? } ?>
                                  ...
                                  <td width="83"><b><font color="#000000">Sent 
                                    On </font> 
                        ...
                        <? } ?>
                                  ...
                                  <font color="#000000"> </font></b></td>
                                  <td width="83"><b><font color="#000000">Read 
                                    On </font> 
                       
                       <? if( $mail->mail_list_sort == 'mrcptdate ASC' ) { ?>
                          	
                          	<input name="sort[mrcptdate DESC]" type="image" src="/img/sort_dwn.gif" width="11" height="12" border="0">
                             
                       <? } else { ?>
                             
                             	<input name="sort[mrcptdate ASC]" type="image" src="/img/sort_up.gif" width="11" height="12" border="0">
                       <? } ?>
                                    </b></td>
                                  <td width="58"><strong><b><font color="#000000">Size 
                                    </font> 
                      ...
                      <? } ?>
                                    <font color="#000000"> </font></b></strong></td>
                                </tr>
                     ...
                     <? } ?>
                      ...
                      <table width="769" border="0" cellspacing="0" cellpadding="0" height="45">
                        <tr valign="middle" class="akalink"> 
                          <td width="318" height="51" valign="bottom"> <input type="image" border="0" name="delete" src="/img/btn_del.gif" width="100" height="35" onMouseOver="window.status='Delete selected e-mail'; return true;" onMouseOut="window.status=''; return true;"> 
