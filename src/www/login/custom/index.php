...
if( !$mail->MailFolderIsByName($_GET['folder']) ) {

	header('Location: http://' . $mail->server['main'] . '/login/inbox');
	exit();
}

$_SESSION['folder_cur']	= $_GET['folder'];
...
if( $mail->MailPostIs('spamunblock') ) {

	$mail->MailMsgUnblock($_POST['mid']);
}
...
if( $_SESSION['folder_cur'] == 'Spam' ) {

	$spambutton	= '<input name="spamunblock" type="image" id="spamunblock" onMouseOver="window.status=\'Selected e-mail(s) are NOT spam\'; return true;" onMouseOut="window.status=\'\'; return true;" src="/img/btn_thisisnotspam.jpg" width="104" height="35" border="0">';

} else {

	$spambuton	= ' <input name="spamblock" type="image" id="spamblock" onMouseOver="window.status=\'Block selected sender from sending you e-mails\'; return true;" onMouseOut="window.status=\'\'; return true;" src="/img/btn_this_is_spam.gif" width="112" height="35" border="0">';
}
          ...
          <tr> 
            <td width="29">&nbsp;</td>
              <td width="761" align="left" valign="top"> <table width="770" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    <td width="509" class="akalink"><font color="#000000"><? print($_SESSION['folder_cur']); ?> 
