...
Thank you for wanting to contribute to AKA Mail. A lot of work is needed to modernize AKA Mail, so all types of contributions are welcome, including code, bug reports, documentation, and new feature suggestions. 
...
7. [Submit a Pull Request (PR)](https://github.com/josephmarino/akamail/compare)
...
If you would like to share an idea for a new feature please [open a new issue ticket](https://github.com/josephmarino/akamail/issues/new) and tag the ticket with the "enhancement" tag.

## I don't want to contribute, I just have a question.

Cool! You can [open a new issue ticket](https://github.com/josephmarino/akamail/issues/new) and tag it with the "help" tag and ask our community for help. Please keep in mind that people working on AKA Mail are volunteers, so it may take some time to respond to your question. 

We always recommend that everyone read the AKA Mail documentation first before opening a ticket with a question, as the answer that you are looking for could be in the documentation.